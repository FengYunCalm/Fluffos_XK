...
void assert_vm_context_contract(mapping contract) {
    ...
    ASSERT_EQ("value_stack_and_object_store_not_owner_local", contract["ordinary_lpc_blocker"]);
    ...
    ASSERT_EQ("value_stack_owner_local", contract["ordinary_lpc_next_blocker"]);
    ASSERT_EQ(11, contract["ordinary_lpc_readiness_gate_count"]);
    ASSERT_EQ(7, contract["ordinary_lpc_satisfied_gate_count"]);
    ASSERT_EQ(4, contract["ordinary_lpc_blocked_gate_count"]);
    ASSERT(arrayp(gates));
    ...
    ASSERT_EQ(0, gate_by_name["value_stack_owner_local"]["satisfied"]);
    ASSERT_EQ("value_stack_process_global",
...
void assert_gateway_owner_task_contract(mapping contract) {
    ...
    ASSERT_EQ("value_stack_owner_local",
    ...
    ASSERT_EQ("ordinary_lpc_ready/value_stack_owner_local",
