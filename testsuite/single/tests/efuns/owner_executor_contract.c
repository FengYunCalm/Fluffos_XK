...
void assert_vm_context_contract(mapping contract) {
    ...
    ASSERT_EQ("control_stack_and_object_store_not_owner_local", contract["ordinary_lpc_blocker"]);
    ...
    ASSERT_EQ(0, contract["control_stack_owner_local"]);
    ASSERT_EQ(0, contract["value_stack_owner_local"]);
    ASSERT_EQ(0, contract["apply_return_owner_local"]);
    ...
    ASSERT_EQ("control_stack_owner_local", contract["ordinary_lpc_next_blocker"]);
    ASSERT_EQ(11, contract["ordinary_lpc_readiness_gate_count"]);
    ASSERT_EQ(6, contract["ordinary_lpc_satisfied_gate_count"]);
    ASSERT_EQ(5, contract["ordinary_lpc_blocked_gate_count"]);
    ASSERT(arrayp(gates));
    ...
    ASSERT_EQ(0, gate_by_name["control_stack_owner_local"]["satisfied"]);
    ASSERT_EQ("control_stack_process_global",
              gate_by_name["control_stack_owner_local"]["blocker"]);
    ASSERT_EQ(0, gate_by_name["apply_return_owner_local"]["satisfied"]);
...
void assert_gateway_owner_task_contract(mapping contract) {
    ...
    ASSERT_EQ("control_stack_owner_local",
    ...
    ASSERT_EQ("ordinary_lpc_ready/control_stack_owner_local",
