...
- heartbeat/callout/async/DNS/socket/gateway command 的真实 owner executor 执行路径。
- array、mapping、object ref 的完整跨线程内存模型。
- driver callback allowlist 到各入口实际迁移的生产路径。
