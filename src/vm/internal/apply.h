...
extern FLUFFOS_VM_THREAD_LOCAL struct svalue_t apply_ret_value;
...
svalue_t *apply_with_context_tracking(const char *, struct object_t *, int, int, bool);
svalue_t *apply_without_context_tracking(const char *, struct object_t *, int, int);
...
int apply_low_shared(const char *, struct object_t *, int);
